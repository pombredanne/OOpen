...
def update_version():
    ...
    hist.close()
    hist = open('info/HISTORY.rst', 'w').write(new_hist)
    return version
...
@task(alias='make_new_readme')
def readme():

    sources_text = ['.. This file is autogenerated. Edit files in info/ to make changes', '\n', '\n']
    sources = """info/INFO.rst info/INSTALL.rst info/HISTORY.rst LICENSE.rst""".split()
